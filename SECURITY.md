...
Never commit secrets, API keys, service-account JSON, tokens, or credentials of any kind to this repository. If you believe a secret has been committed, rotate it immediately and notify the maintainer.
